...
const queue = new Queue("miniProjectQueue");

const bgSyncPlugin = new BackgroundSyncPlugin("myQueueMiniProject", {
...
registerRoute(
  /^https:\/\/6564bb89ceac41c0761eba72.mockapi.io\/api\/miniproject/,
  new NetworkOnly({
